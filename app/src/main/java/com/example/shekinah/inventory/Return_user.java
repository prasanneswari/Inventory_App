...
public class Return_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonval = deldev_jsonstr(eid,rtnid);
...
// generate a random integer from 0 to 899, then add 100
    ...
    public void dev_respons(JSONObject response) {
        ...
        try {
            ...
            login_jarray = response.getJSONArray("get_returns");
                /*if(new_array!=null){
...
*/
            ...
            for (int i = 0, count = login_jarray.length(); i < count; i++) {
                ...
                String productid = login_jarray.getJSONObject(i).getString("productid");
                String prodtnm = login_jarray.getJSONObject(i).getString("productname");
                String qntytisd = login_jarray.getJSONObject(i).getString("quantityissued");
                ...
                contact.put("quantityissued", qnttreq);
                contact.put("qreturn", String.valueOf(0));
                int  bal= Integer.parseInt(qnttreq)-0;
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Return_user.this, contactList,
                    R.layout.retun_user_store, new String[]{"productid", "productname",
                    "quantityissued","qreturn","qtybal"}, new int[]{R.id.pid,
                    R.id.pnamid, R.id.qntakeid, R.id.qntyreturnid, R.id.qntybalid});
            rtrnval.setAdapter(adapter);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(check){
                            ...
                            Intent intent = new Intent(Return_user.this, user_history.class);
    ...
    public void add_espdtdialog()
    {
        ...
        openDialog = new Dialog(Return_user.this,R.style.DialogTheme);
...
//                    finalva[0] =String.valueOf(i[0]);
        ...
        svbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                jsonval =  request_return(contactList.get(poslist).get("quantityissued"),String.valueOf(k[0]),contactList.get(poslist).get("detailsid"));

...
import static com.example.shekinah.inventory.Adapter_userforecast.lforecastid;

public class Forecasting extends AppCompatActivity {
    String[] idA, pidA, productnameA, productdescriptionA, statusId_idA, requisitionidA, idUA, qtyRA, qtyIA, qtyStatusA, productnameRA;
    String jsonS, urlrs, pid1, prdQS="",ProjectS, prdSelectedS, jtsproductid = "", jtsproductquantity = "";
    ListView ListPrd, PrdDetails;
    EditText projectEdt, prdQ;
    Button Add1;
    EditText searchTxt;
    CheckBox check;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        projectEdt=(EditText)findViewById(R.id.projectid);
        ...
        ReqDueDt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                DatePickerDialog datePickerDialog = new DatePickerDialog(Forecasting.this,
        ...
        addP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProjectS=projectEdt.getText().toString();
                Log.d("pid1.charAt(0)", "in add component--" + pid1.substring(0, 1)); //C
                if (prdQS.contentEquals("") || prdSelectedS.contentEquals("Select Product...")|| ProjectS.contentEquals("Select Project...")) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Forecasting.this);
                    ...
                    builder.setMessage("Your selected Project: " + ProjectS);
                    ...
                    Adapter_Forecast reqAdapter = new Adapter_Forecast(Forecasting.this, qtyRA, qtyIA, qtyStatusA, productnameRA);
        ...
        prdSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder2 = new AlertDialog.Builder(Forecasting.this);
                ...
                builder2.setPositiveButton("Search", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        AlertDialog.Builder search = new AlertDialog.Builder(Forecasting.this);
                        search.setTitle("Product Search...");
                        search.setMessage("Enter Product: ");

                        searchTxt = new EditText(Forecasting.this);
            ...
            public void onClick(View view) {
                ...
                if (check.isChecked()) {
                    ...
                    if (!ReqDueDt.getText().toString().contentEquals("Choose Date")) {
                        ...
                        //jsonS = "{\"userid\":\"3\",\"duedate\":\"" + ReqDueDt.getText().toString() + "\",\"quantity\":\"" + q + "\",\"productid\":\"" + p + "\",\"returnid\":\"" + "1" + "\",\"jtsproductid\":\"" + jtsproductid + "\",\"jtsproductquantity\":\"" + jtsproductquantity + "\"}";
                        jsonS = "{\"userid\":\"3\",\"projectname\":\"" + projectEdt.getText().toString() + "\",\"duedate\":\"" + ReqDueDt.getText().toString() + "\",\"quantity\":\"" + q + "\",\"productid\":\"" + p + "\"}";
                        Log.d("-jsnresponse add---", "jsonS: " + jsonS);
                        String urlrs = "http://"+domain_name+":"+port+"/InventoryApp/add_forecast/";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0, count = new_array1.length(); i < count; i++) {
                                ...
                                String requisitionidS = lforecastid;
                                Log.d("-prdQS  ---", "" + prdQS);
                                String qtyRS = prdQS;
                                String qtyIS = "0";
                                String qtyStatusS = "Not Issued";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            final AlertDialog.Builder builder3 = new AlertDialog.Builder(Forecasting.this);
...
//                            });
                        ...
                        try {
                            ...
                            final AlertDialog.Builder builder = new AlertDialog.Builder(Forecasting.this);
                        ...
                        try {
                            ...
                            builder.setNegativeButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Intent intent = new Intent(Forecasting.this, User_Forecast.class);

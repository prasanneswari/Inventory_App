...
public class Locations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog_progress = new ProgressDialog(Locations.this);
        ...
        AddLocB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Locations.this, AddLoc.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            LocationAdapter reqAdapter = new LocationAdapter(Locations.this,idA, locationNameA, locationAddressA, statusId_idA);

...
import static com.example.shekinah.inventory.PosPrdSearchAdapter.pName;
import static com.example.shekinah.inventory.UserMainAdapter.urID;
import static com.example.shekinah.inventory.UpdatePosition.from;
import static com.example.shekinah.inventory.UpdatePosition.quantityidS;

public class PosPrdSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pos_prd_search);
        ...
        ListPrd = (ListView)findViewById(R.id.listPrd2);
        dialog_progress = new ProgressDialog(PosPrdSearch.this);
        ...
        Cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PosPrdSearch.this, UpdatePosition.class);
    ...
    public void add(){
        if(from.contentEquals("change")){

            AlertDialog.Builder builder = new AlertDialog.Builder(PosPrdSearch.this);
            builder.setTitle("Selected Product.. : "+ pName);
            builder.setMessage("Enter Quantity : ");
            input = new EditText(PosPrdSearch.this);
...
//                    dialog_progress.setMessage("connecting ...");
//                    dialog_progress.show();
                    //{"quantityid":"2","quantity":"30","productid":"10","positionid":"1","locationid":"1","warehouseid":"1"}
                    String jsonS = "{\"quantityid\":\"" + quantityidS + "\",\"quantity\":\""+input.getText().toString()+"\",\"productid\":\""+pID+"\",\"positionid\":\"" + poID + "\",\"locationid\":\"1\",\"warehouseid\":\"1\"}";
            ...
            builder.setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    dialog_progress.setMessage("connecting ...");
                    dialog_progress.show();
                    String jsonS = "{\"quantity\":\""+input.getText().toString()+"\",\"productid\":\""+pID+"\",\"positionid\":\"" + poID + "\",\"locationid\":\"\",\"warehouseid\":\"\"}";
                    Log.d("-jsnresponse add---",""+jsonS);
                    String urlrs ="http://"+domain_name+":"+port+"/InventoryApp/add_productquantity/";
                    try {
                        JSONObject rmdt = null;
...
//                                producttypeA[l] = producttypeL.get(l);
                            ...
                            PosPrdSearchAdapter reqAdapter = new PosPrdSearchAdapter(PosPrdSearch.this,idA, productnameA, productdescriptionA, statusId_idA);
...
//        AppController.getInstance().addToRequestQueue(jsonObjReq,tag_json_obj);
    ...
    public void addVolley(String url, final JSONObject json)
    {
        Log.d("---url-----", "---"+url);
        Log.d("555555", "00000000"+json.toString());
